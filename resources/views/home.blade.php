...
@section('content')
    <div class="container-fluid">
        ...
        <h4 class="text-center pt-4 d-flex flex-wrap align-items-center justify-content-center text-muted">
            ...
            <span id="display-date-full" class="ms-1 me-1 text-muted"></span> <span id="holiday-found-section"
                class="d-none"> svátek má<span id="holiday-name" class="ms-1"></span>.
        ...
        <div class="row justify-content-center mb-4 mt-5">
            ...
            <div class="col-4 col-sm-12 col-md-8 col-lg-2 d-flex justify-content-center align-items-center mb-4">
                <div
                    class="card-circle-weather d-flex flex-column justify-content-center align-items-center text-center text-white">
            ...
            <div class="col-4 col-sm-12 col-md-8 col-lg-2 d-flex justify-content-center align-items-center mb-4">
                <div
                    class="card-circle animated-circle-red bg-circle-shadow-red d-flex flex-column justify-content-center align-items-center text-center text-white">
                    <canvas id="clock" width="243" height="245" aria-label="Analogové hodiny"></canvas>
                </div>
            </div>
            ...
            <div class="col-4 col-sm-12 col-md-8 col-lg-2 d-flex justify-content-center align-items-center mb-4">
                <div
                    class="card-circle animated-circle-blue bg-circle-shadow-blue d-flex flex-column justify-content-center align-items-center text-center text-white">
                    <div class="nadpis mb-2">Vynaložená částka <br> za rok <span id="rok-zobrazeni"></span> </div>
                    <h6 id="celkova-castka" class="text-muted">— Kč</h6>
            ...
            <div class="col-4 col-sm-5 col-md-8 col-lg-2 d-flex justify-content-center align-items-center mb-4">
                <div
                    class="card-circle animated-circle-orange bg-circle-shadow-orange d-flex flex-column justify-content-center align-items-center text-center text-white">
                    <h6 class="mb-2 overflow px-4">Objednávky u dodavatele</h6>
                    <h2 class="mb-xl-4 mb-sm-2" id="obje-count">0</h2>
            ...
            <div class="col-4 col-sm-5 col-md-8 col-lg-2 d-flex justify-content-center align-items-center mb-4">
                <div
                    class="card-circle animated-circle-green bg-circle-shadow-green d-flex flex-column justify-content-center align-items-center text-center text-white">
                    <h6 class="mb-2 overflow px-5">Čekající požadavky</h6>
                    <h2 class="mb-xl-4 mb-sm-1" id="ceka-count">0</h2>
