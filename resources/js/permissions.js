    ...
    function createRoleItem(role) {
        ...
        div.innerHTML = `
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button class="btn btn-sm btn-primary" data-action="edit-role" data-id="${role.id}">
 ...
 */
    ...
    function setupEventListeners() {
        // Delegace pro tlačítka rolí (dynamicky generované)
        const rolesList = document.getElementById('roles-list');
        if (rolesList) {
            rolesList.addEventListener('click', (e) => {
                const btn = e.target.closest('[data-action="edit-role"]');
                if (btn) editRole(parseInt(btn.dataset.id));
            });
        }
